...
function FuxDataTableFilter(settings) {
    ...
    return {
        ...
        getElement: function (name, onChange) {
            ...
            switch (settings.type) {
                ...
                case 'date_range':
                    ...
                    FuxDataTableFilter.core.loadDateRangePickerJS(function(){
                        $(filterControl).daterangepicker({}, function (start, end, label) {
                            onChange(name, {
            ...
            if (settings.type !== FuxDataTableFilter.types.DATE_RANGE) {
...
FuxDataTableFilter.core = {
    loadDateRangePickerJS: function (load) {
        ...
        if (FuxDataTableFilter.core.loadDateRangePickerJS_done) return;
        FuxDataTableFilter.core.loadDateRangePickerJS_done = true;
        //Load CSS
